...
extension BucketList {
    ...
    class ViewModel {
        ...
        private(set) var mapMode: MapMode = .standard
        ...
        func authenticate() {
            ...
            if context.canEvaluatePolicy(.deviceOwnerAuthenticationWithBiometrics, error: &error) {
                ...
                self.showingErrorAlert = true
                self.errorMessage = AuthenticationError.notAvailable.localizedDescription
            }
        }
        
        func update(mapMode: MapMode) {
